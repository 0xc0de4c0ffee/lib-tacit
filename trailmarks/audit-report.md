# lib-tacit Audit: trailmark cross-comparison
...
| --- | --- | --- |
| payload.slice | 253 | payload.slice |
| w.push | 209 | w.push |
| crypto.pedersen:modN | 181 | crypto.pedersen:modN |
| crypto.pedersen:bytesToPoint | 59 | crypto.pedersen:bytesToPoint |
| w.u8 | 54 | w.u8 |
| transcript.append | 42 | transcript.append |
| envelope.payload:readU64LE | 41 | envelope.payload:readU64LE |
| crypto.pedersen:pointToBytes | 38 | crypto.pedersen:pointToBytes |
| te.encode | 37 | te.encode |
| parts.push | 34 | parts.push |
| crypto.pedersen:bytes32ToBigint | 33 | crypto.pedersen:bytes32ToBigint |
| w.out | 30 | w.out |
| opcodes.cbtc-tac:BigInt | 30 | opcodes.cbtc-tac:BigInt |
| opcodes.slot:BigInt | 27 | opcodes.slot:BigInt |
| transaction.utils:bytesToHex | 25 | transaction.utils:bytesToHex |
