...
- **Bulletproofs** — aggregated range proofs (n=64 bits, m ∈ {1,2,4,8}) with Pippenger MSM
...
- **Opcode encode/decode** — 14 shipped opcodes:
...
├── opcodes/       — 14 shipped + 6 stub/draft modules (see AGENTS.md for full list)
├── transaction/   — BIP-143 sighash, TX serialization, P2WPKH address
├── wallet/        — Keypair generation, import, export
...
```bash
bun test      # 83+ tests across 21 files, isolated from tacit-specs/
```
